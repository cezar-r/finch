...
## [1.0.1](https://github.com/cezar-r/finch/compare/v1.2.3...v1.0.1) (2024-09-19)


### Build System or External Dependencies

* add local-core Makefile target ([#351](https://github.com/cezar-r/finch/issues/351)) ([f86c56f](https://github.com/cezar-r/finch/commit/f86c56f68273cc4d8c9584477793fc7efa148e76))
* clean up finch-core _output directory in clean target ([#290](https://github.com/cezar-r/finch/issues/290)) ([4684a95](https://github.com/cezar-r/finch/commit/4684a959205a1f701ede8b59e7822354cb7d0d70))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.21.2 to 1.22.0 ([#677](https://github.com/cezar-r/finch/issues/677)) ([c450dc9](https://github.com/cezar-r/finch/commit/c450dc96b5f09b57adcf48a62c09138bc04f3df5))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.22.0 to 1.22.1 ([#682](https://github.com/cezar-r/finch/issues/682)) ([2537aa6](https://github.com/cezar-r/finch/commit/2537aa6490f411551f162255d152805cb5c47951))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.22.1 to 1.23.5 ([#716](https://github.com/cezar-r/finch/issues/716)) ([feedd95](https://github.com/cezar-r/finch/commit/feedd953825f8736736fa6c796a4bb72cf70aabd))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.23.5 to 1.24.0 ([#729](https://github.com/cezar-r/finch/issues/729)) ([963d278](https://github.com/cezar-r/finch/commit/963d278df6cfb2c660f25601a916293b29d51bc8))
* **deps:** Bump github.com/aws/aws-sdk-go-v2 from 1.24.0 to 1.24.1 ([#749](https://github.com/cezar-r/finch/issues/749)) ([c3ae967](https://github.com/cezar-r/finch/commit/c3ae96794165b4ea696bb94856d40ff91767ed1b))
...
* **deps:** Bump github.com/containerd/containerd from 1.7.10 to 1.7.11 ([#742](https://github.com/cezar-r/finch/issues/742)) ([7d1e250](https://github.com/cezar-r/finch/commit/7d1e25068a503a8b4ea7dd3f349ff4020168a6fb))
...
* **deps:** Bump github.com/docker/cli from 24.0.4+incompatible to 24.0.5+incompatible ([#495](https://github.com/cezar-r/finch/issues/495)) ([e9e8617](https://github.com/cezar-r/finch/commit/e9e8617b07301848dc1f6c3afa18643d212d024e))
* **deps:** Bump github.com/docker/cli from 24.0.5+incompatible to 24.0.6+incompatible ([#560](https://github.com/cezar-r/finch/issues/560)) ([21bb893](https://github.com/cezar-r/finch/commit/21bb893105f0a4fc5541e3a8e9f5306edb739154))
* **deps:** Bump github.com/docker/cli from 24.0.6+incompatible to 24.0.7+incompatible ([#665](https://github.com/cezar-r/finch/issues/665)) ([43a57ff](https://github.com/cezar-r/finch/commit/43a57ffc052ba1ffcf0f50cdb08dfdb42abc9723))
...
* **deps:** Bump github.com/docker/docker from 23.0.1+incompatible to 23.0.2+incompatible ([#320](https://github.com/cezar-r/finch/issues/320)) ([ee3df9a](https://github.com/cezar-r/finch/commit/ee3df9a31e4ebab872001ba7756a81a49aaa9ad5))
* **deps:** Bump github.com/docker/docker from 23.0.2+incompatible to 23.0.3+incompatible ([#343](https://github.com/cezar-r/finch/issues/343)) ([6cfbb9f](https://github.com/cezar-r/finch/commit/6cfbb9ffa3a9bc3b3c06235dffbc6c7625d5aede))
* **deps:** Bump github.com/docker/docker from 23.0.3+incompatible to 23.0.5+incompatible ([#382](https://github.com/cezar-r/finch/issues/382)) ([3e0581c](https://github.com/cezar-r/finch/commit/3e0581cc0f86efcd9ce7b7dc8c9384fb1e6af785))
* **deps:** Bump github.com/docker/docker from 23.0.5+incompatible to 23.0.6+incompatible ([#394](https://github.com/cezar-r/finch/issues/394)) ([f44bc2e](https://github.com/cezar-r/finch/commit/f44bc2eb14011640f7a25218bbc18a82d533e76a))
* **deps:** Bump github.com/docker/docker from 23.0.6+incompatible to 24.0.0+incompatible ([#406](https://github.com/cezar-r/finch/issues/406)) ([25aa324](https://github.com/cezar-r/finch/commit/25aa324ca324248cf2093af23f205af1b5ae276f))
* **deps:** Bump github.com/docker/docker from 24.0.0+incompatible to 24.0.1+incompatible ([#413](https://github.com/cezar-r/finch/issues/413)) ([bb1cab2](https://github.com/cezar-r/finch/commit/bb1cab229c787752615eb00e74f240c4a4e0e23d))
* **deps:** Bump github.com/docker/docker from 24.0.1+incompatible to 24.0.2+incompatible ([#419](https://github.com/cezar-r/finch/issues/419)) ([f6f8aeb](https://github.com/cezar-r/finch/commit/f6f8aeb40fa0b2cfaa807c98eb3576ca262d75aa))
* **deps:** Bump github.com/docker/docker from 24.0.2+incompatible to 24.0.4+incompatible ([#469](https://github.com/cezar-r/finch/issues/469)) ([ad37f4f](https://github.com/cezar-r/finch/commit/ad37f4fbce72a6f479620461127e8fe494d47cad))
* **deps:** Bump github.com/docker/docker from 24.0.2+incompatible to 24.0.4+incompatible ([#481](https://github.com/cezar-r/finch/issues/481)) ([15d2a4b](https://github.com/cezar-r/finch/commit/15d2a4bf8cfd3956a2f8bb4878bfb86827b4e77d))
* **deps:** Bump github.com/docker/docker from 24.0.4+incompatible to 24.0.5+incompatible ([#497](https://github.com/cezar-r/finch/issues/497)) ([6f1afbb](https://github.com/cezar-r/finch/commit/6f1afbb69554148efd8eea938278bcc5104ab050))
* **deps:** Bump github.com/docker/docker from 24.0.5+incompatible to 24.0.6+incompatible ([#561](https://github.com/cezar-r/finch/issues/561)) ([e0160be](https://github.com/cezar-r/finch/commit/e0160be4b90b9db0e9e544a8ad9b170c08b38756))
* **deps:** Bump github.com/docker/docker from 24.0.6+incompatible to 24.0.7+incompatible ([#666](https://github.com/cezar-r/finch/issues/666)) ([4e06d28](https://github.com/cezar-r/finch/commit/4e06d283512ed851279cb4988089f1c610896ba9))
...
* **deps:** Bump github.com/docker/docker from 26.1.3+incompatible to 26.1.4+incompatible ([#972](https://github.com/cezar-r/finch/issues/972)) ([05b9c05](https://github.com/cezar-r/finch/commit/05b9c0506b7c482b916445a4e53664846c5c45b6))
...
* **deps:** Bump github.com/lima-vm/lima from 0.15.0 to 0.15.1 ([#365](https://github.com/cezar-r/finch/issues/365)) ([1d3ee98](https://github.com/cezar-r/finch/commit/1d3ee985427e601bf3f5659c3bba13467ec01ce0))
* **deps:** Bump github.com/lima-vm/lima from 0.15.1 to 0.16.0 ([#428](https://github.com/cezar-r/finch/issues/428)) ([6a67f0c](https://github.com/cezar-r/finch/commit/6a67f0cfb0a3a1da438779f4faa04048f25d7dde))
* **deps:** Bump github.com/lima-vm/lima from 0.16.0 to 0.17.2 ([#531](https://github.com/cezar-r/finch/issues/531)) ([6e33d15](https://github.com/cezar-r/finch/commit/6e33d159e2f522784860bc60ceea897a98d1fe5f))
* **deps:** Bump github.com/lima-vm/lima from 0.17.2 to 0.18.0 ([#643](https://github.com/cezar-r/finch/issues/643)) ([f181b89](https://github.com/cezar-r/finch/commit/f181b8970c6d63a25d22be44820d1570c95b6f41))
* **deps:** Bump github.com/lima-vm/lima from 0.18.0 to 0.19.0 ([#721](https://github.com/cezar-r/finch/issues/721)) ([2058164](https://github.com/cezar-r/finch/commit/20581647a1949e7e9d258e851dd25a1105168410))
...
* **deps:** bump github.com/lima-vm/lima from 0.22.0 to 0.23.1 ([#1066](https://github.com/cezar-r/finch/issues/1066)) ([09d7355](https://github.com/cezar-r/finch/commit/09d73552047e83b3bafcbbafab3e9efdbf93ea64))
...
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.10.0 to 2.11.0 ([#456](https://github.com/cezar-r/finch/issues/456)) ([f7e0916](https://github.com/cezar-r/finch/commit/f7e091670fb2ac5377423e72f98aa8be33aa41c8))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.11.0 to 2.12.0 ([#542](https://github.com/cezar-r/finch/issues/542)) ([8536481](https://github.com/cezar-r/finch/commit/85364818e9f5a9ca1993fa7a3fc8ce775e002a42))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.13.1 to 2.13.2 ([#708](https://github.com/cezar-r/finch/issues/708)) ([cbbd064](https://github.com/cezar-r/finch/commit/cbbd0645aaa5164ffe9eb31d1d1ab7220a50a03e))
...
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.2 to 2.9.3 ([#390](https://github.com/cezar-r/finch/issues/390)) ([7102994](https://github.com/cezar-r/finch/commit/710299445ed287c67114b277be7bd2a29715956b))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.3 to 2.9.5 ([#400](https://github.com/cezar-r/finch/issues/400)) ([65458f1](https://github.com/cezar-r/finch/commit/65458f1b0c20705e724ac07356d87dd47ae2000c))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.5 to 2.9.7 ([#432](https://github.com/cezar-r/finch/issues/432)) ([0a381f1](https://github.com/cezar-r/finch/commit/0a381f17ea2602bc3b19f9b2101da9e3a589f6d3))
* **deps:** Bump github.com/onsi/ginkgo/v2 from 2.9.7 to 2.10.0 ([#449](https://github.com/cezar-r/finch/issues/449)) ([a415e3e](https://github.com/cezar-r/finch/commit/a415e3ef7b2741853bf352b915c4100c77600619))
* **deps:** Bump github.com/onsi/gomega from 1.27.10 to 1.28.0 ([#583](https://github.com/cezar-r/finch/issues/583)) ([9d1ad57](https://github.com/cezar-r/finch/commit/9d1ad5748967b8b978131ddb50071200fcceffde))
* **deps:** Bump github.com/onsi/gomega from 1.27.3 to 1.27.5 ([#312](https://github.com/cezar-r/finch/issues/312)) ([e078234](https://github.com/cezar-r/finch/commit/e07823454ba86701ff7316e8c44e78d1c5ceb454))
* **deps:** Bump github.com/onsi/gomega from 1.27.5 to 1.27.6 ([#331](https://github.com/cezar-r/finch/issues/331)) ([fe388a3](https://github.com/cezar-r/finch/commit/fe388a31f830f854abacb06729ddf710040e9e62))
* **deps:** Bump github.com/onsi/gomega from 1.27.6 to 1.27.7 ([#409](https://github.com/cezar-r/finch/issues/409)) ([80513c7](https://github.com/cezar-r/finch/commit/80513c7785a6da4ae09d9c871acaf180f5d68f2c))
* **deps:** Bump github.com/onsi/gomega from 1.27.7 to 1.27.8 ([#448](https://github.com/cezar-r/finch/issues/448)) ([96fc8d0](https://github.com/cezar-r/finch/commit/96fc8d09a051b2ead932e6eef064624b1a842b66))
* **deps:** Bump github.com/onsi/gomega from 1.27.8 to 1.27.10 ([#496](https://github.com/cezar-r/finch/issues/496)) ([d08d102](https://github.com/cezar-r/finch/commit/d08d102d05a350a8b8e586c42ef83d51495cf4f9))
* **deps:** Bump github.com/onsi/gomega from 1.28.0 to 1.29.0 ([#662](https://github.com/cezar-r/finch/issues/662)) ([5c9de37](https://github.com/cezar-r/finch/commit/5c9de37cb8ba8a4d5cabfe3c640239bd1afa87e0))
* **deps:** Bump github.com/onsi/gomega from 1.29.0 to 1.30.0 ([#693](https://github.com/cezar-r/finch/issues/693)) ([2b0c54c](https://github.com/cezar-r/finch/commit/2b0c54c85a227bdca0189a3e96b9981289759f53))
...
* **deps:** Bump github.com/pkg/sftp from 1.13.5 to 1.13.6 ([#530](https://github.com/cezar-r/finch/issues/530)) ([09b3846](https://github.com/cezar-r/finch/commit/09b38467333e5e59eadb76cd5f4612768cde5289))
* **deps:** Bump github.com/runfinch/common-tests from 0.6.4 to 0.6.5 ([#357](https://github.com/cezar-r/finch/issues/357)) ([dc84864](https://github.com/cezar-r/finch/commit/dc848640b719c623dbf606439e6e3e1d9dcd02d6))
* **deps:** Bump github.com/runfinch/common-tests from 0.6.5 to 0.7.0 ([#420](https://github.com/cezar-r/finch/issues/420)) ([ac18046](https://github.com/cezar-r/finch/commit/ac18046e70efc0e1e9fe11a30457f6f945df2a23))
* **deps:** Bump github.com/runfinch/common-tests from 0.7.0 to 0.7.1 ([#477](https://github.com/cezar-r/finch/issues/477)) ([54c03bb](https://github.com/cezar-r/finch/commit/54c03bbfba132d797b0efa1171ce3fdc6eb8af9e))
...
* **deps:** Bump github.com/runfinch/common-tests from 0.7.2 to 0.7.3 ([#548](https://github.com/cezar-r/finch/issues/548)) ([a054ef3](https://github.com/cezar-r/finch/commit/a054ef3aa028b2c50fca93631a7b547b9c535f2e))
...
* **deps:** Bump github.com/runfinch/common-tests from 0.7.6 to 0.7.7 ([#609](https://github.com/cezar-r/finch/issues/609)) ([e21ae83](https://github.com/cezar-r/finch/commit/e21ae836d4f73ea07852e3cd1fc6cc16d56e4f32))
* **deps:** Bump github.com/runfinch/common-tests from 0.7.7 to 0.7.8 ([#617](https://github.com/cezar-r/finch/issues/617)) ([4d942f5](https://github.com/cezar-r/finch/commit/4d942f550c86106a224e97f32f1bf90f1b4d44cb))
* **deps:** Bump github.com/runfinch/common-tests version from v0.6.2 to v0.6.3 ([#328](https://github.com/cezar-r/finch/issues/328)) ([1c44b3e](https://github.com/cezar-r/finch/commit/1c44b3e270aa2e2ebb237e86f17f3a9519ec124b))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.10 to 3.23.11 ([#720](https://github.com/cezar-r/finch/issues/720)) ([defc6c5](https://github.com/cezar-r/finch/commit/defc6c55050dceab6273e501796b918ce8c86075))
...
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.3 to 3.23.4 ([#389](https://github.com/cezar-r/finch/issues/389)) ([76b31c0](https://github.com/cezar-r/finch/commit/76b31c0c453935f22588523f65888e103581cd89))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.4 to 3.23.5 ([#437](https://github.com/cezar-r/finch/issues/437)) ([8635294](https://github.com/cezar-r/finch/commit/8635294bcb22207bfdaa3f96756f93ba580ff6e2))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.5 to 3.23.6 ([#464](https://github.com/cezar-r/finch/issues/464)) ([43a6720](https://github.com/cezar-r/finch/commit/43a672011fd47830073b8cc7427f82c6f1c3e5bd))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.6 to 3.23.7 ([#513](https://github.com/cezar-r/finch/issues/513)) ([83bd718](https://github.com/cezar-r/finch/commit/83bd718be67ddba624e8218034c91bf399e2cccd))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.7 to 3.23.8 ([#552](https://github.com/cezar-r/finch/issues/552)) ([cf9399a](https://github.com/cezar-r/finch/commit/cf9399a5dd125b875d6212b029ed19530898cdee))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.8 to 3.23.9 ([#588](https://github.com/cezar-r/finch/issues/588)) ([20385b7](https://github.com/cezar-r/finch/commit/20385b7c5c0a45f5495615ebb3ce70220ab15969))
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.23.9 to 3.23.10 ([#678](https://github.com/cezar-r/finch/issues/678)) ([1b2b823](https://github.com/cezar-r/finch/commit/1b2b823da40454ac55b755145840bc5b03ab3091))
...
* **deps:** Bump github.com/shirou/gopsutil/v3 from 3.24.2 to 3.24.3 ([#881](https://github.com/cezar-r/finch/issues/881)) ([465e369](https://github.com/cezar-r/finch/commit/465e369479fb803dde75be02ee4a8e37c3a3ffdf))
...
* **deps:** Bump github.com/sirupsen/logrus from 1.9.0 to 1.9.1 ([#405](https://github.com/cezar-r/finch/issues/405)) ([05b6b2e](https://github.com/cezar-r/finch/commit/05b6b2e7364036a3d30b67ad409f55526cc59ffe))
* **deps:** Bump github.com/sirupsen/logrus from 1.9.1 to 1.9.2 ([#408](https://github.com/cezar-r/finch/issues/408)) ([0ff477a](https://github.com/cezar-r/finch/commit/0ff477ab32e2c427bbc800b6ae65efc72b5ed1eb))
* **deps:** Bump github.com/sirupsen/logrus from 1.9.2 to 1.9.3 ([#446](https://github.com/cezar-r/finch/issues/446)) ([1823677](https://github.com/cezar-r/finch/commit/18236774d971065dec28d1db204e1f697d418a9b))
* **deps:** Bump github.com/spf13/afero from 1.10.0 to 1.11.0 ([#705](https://github.com/cezar-r/finch/issues/705)) ([928574f](https://github.com/cezar-r/finch/commit/928574f45f5990627d469a4d5074ef3de104519c))
* **deps:** Bump github.com/spf13/cobra from 1.6.1 to 1.7.0 ([#341](https://github.com/cezar-r/finch/issues/341)) ([6a77f72](https://github.com/cezar-r/finch/commit/6a77f721f35779bd112d5e1206bf034940a43a23))
* **deps:** Bump github.com/spf13/cobra from 1.7.0 to 1.8.0 ([#686](https://github.com/cezar-r/finch/issues/686)) ([00ba174](https://github.com/cezar-r/finch/commit/00ba174ad1c59981f6ce48bf80fc7e41cfed301b))
...
* **deps:** Bump github.com/stretchr/testify from 1.8.2 to 1.8.4 ([#429](https://github.com/cezar-r/finch/issues/429)) ([0f7750e](https://github.com/cezar-r/finch/commit/0f7750ebeee01108a9f6a6fcfe0c7f5f044bc336))
...
* **deps:** Bump golang.org/x/crypto from 0.10.0 to 0.11.0 ([#465](https://github.com/cezar-r/finch/issues/465)) ([dc5a3e7](https://github.com/cezar-r/finch/commit/dc5a3e7240d4af6b63874e239bc77bed04d2a0a6))
* **deps:** Bump golang.org/x/crypto from 0.12.0 to 0.13.0 ([#558](https://github.com/cezar-r/finch/issues/558)) ([f24264d](https://github.com/cezar-r/finch/commit/f24264d30805252d91b531c2bca8d9c883b88196))
* **deps:** Bump golang.org/x/crypto from 0.14.0 to 0.15.0 ([#692](https://github.com/cezar-r/finch/issues/692)) ([fba68ff](https://github.com/cezar-r/finch/commit/fba68ff03c01032665793b0f27681173ec03ceec))
* **deps:** Bump golang.org/x/crypto from 0.15.0 to 0.16.0 ([#704](https://github.com/cezar-r/finch/issues/704)) ([f6a920f](https://github.com/cezar-r/finch/commit/f6a920fc80bf7be954527fe5bd765dddcd0d5db5))
* **deps:** Bump golang.org/x/crypto from 0.16.0 to 0.18.0 ([#751](https://github.com/cezar-r/finch/issues/751)) ([fc434ac](https://github.com/cezar-r/finch/commit/fc434ac4f288bb1d2eeef3c2e2bcb186e8aa5278))
...
* **deps:** Bump golang.org/x/crypto from 0.7.0 to 0.8.0 ([#349](https://github.com/cezar-r/finch/issues/349)) ([82b27c9](https://github.com/cezar-r/finch/commit/82b27c9bb1424ef47fe05cf805aebc337af3bc5e))
* **deps:** Bump golang.org/x/crypto from 0.8.0 to 0.9.0 ([#397](https://github.com/cezar-r/finch/issues/397)) ([f15c2ee](https://github.com/cezar-r/finch/commit/f15c2ee576416c0cb25de45438bd894ca6b1fdcb))
* **deps:** Bump golang.org/x/crypto from 0.9.0 to 0.10.0 ([#451](https://github.com/cezar-r/finch/issues/451)) ([fef6e77](https://github.com/cezar-r/finch/commit/fef6e772c28429ef14068702c1dfd8e9fec2dea1))
* **deps:** Bump golang.org/x/image from 0.0.0-20210220032944-ac19c3e999fb to 0.10.0 ([#752](https://github.com/cezar-r/finch/issues/752)) ([9a08b45](https://github.com/cezar-r/finch/commit/9a08b45466cc58326df05d94dfe91edd07158759))
...
* **deps:** Bump golang.org/x/tools from 0.10.0 to 0.11.0 ([#466](https://github.com/cezar-r/finch/issues/466)) ([a8b32f9](https://github.com/cezar-r/finch/commit/a8b32f9674f93cfe54686a2e29b4cf6ca4534939))
* **deps:** Bump golang.org/x/tools from 0.11.0 to 0.11.1 ([#509](https://github.com/cezar-r/finch/issues/509)) ([e826bcf](https://github.com/cezar-r/finch/commit/e826bcff385946bb6629db8935d3aa912befb5bb))
* **deps:** Bump golang.org/x/tools from 0.11.1 to 0.12.0 ([#523](https://github.com/cezar-r/finch/issues/523)) ([09d6514](https://github.com/cezar-r/finch/commit/09d6514bfba31a898e3b3407964113f21fb6b244))
* **deps:** Bump golang.org/x/tools from 0.12.0 to 0.13.0 ([#559](https://github.com/cezar-r/finch/issues/559)) ([0f56d23](https://github.com/cezar-r/finch/commit/0f56d23b4e9210960c02822cd19a8a47326caa0e))
* **deps:** Bump golang.org/x/tools from 0.13.0 to 0.14.0 ([#610](https://github.com/cezar-r/finch/issues/610)) ([8938cf3](https://github.com/cezar-r/finch/commit/8938cf394f12b42da976c2963fad82c42a52aa85))
* **deps:** Bump golang.org/x/tools from 0.14.0 to 0.16.0 ([#706](https://github.com/cezar-r/finch/issues/706)) ([6f021a2](https://github.com/cezar-r/finch/commit/6f021a29fbabb35ef3b5b406d10932c81d2bd0c3))
* **deps:** Bump golang.org/x/tools from 0.16.0 to 0.16.1 ([#734](https://github.com/cezar-r/finch/issues/734)) ([efecfca](https://github.com/cezar-r/finch/commit/efecfcae8922f47581a4575125acbe375a706b11))
...
* **deps:** bump golang.org/x/tools from 0.22.0 to 0.23.0 ([#1019](https://github.com/cezar-r/finch/issues/1019)) ([81b2446](https://github.com/cezar-r/finch/commit/81b2446a3a9f4d13364951e26c2f716a0ab956f7))
...
* **deps:** Bump golang.org/x/tools from 0.7.0 to 0.8.0 ([#348](https://github.com/cezar-r/finch/issues/348)) ([aaca2c9](https://github.com/cezar-r/finch/commit/aaca2c994a2c146e751c43fbb4fabb78041da98d))
* **deps:** Bump golang.org/x/tools from 0.9.1 to 0.9.3 ([#443](https://github.com/cezar-r/finch/issues/443)) ([b192874](https://github.com/cezar-r/finch/commit/b192874e2b1c5de1c2148813760cbe65e15d7553))
* **deps:** Bump golang.org/x/tools from 0.9.3 to 0.10.0 ([#455](https://github.com/cezar-r/finch/issues/455)) ([e321f1d](https://github.com/cezar-r/finch/commit/e321f1dc607626a7f65b33e0a0f503d8c856b1f2))
* **deps:** Bump google.golang.org/grpc from 1.53.0 to 1.56.3 ([#658](https://github.com/cezar-r/finch/issues/658)) ([321487c](https://github.com/cezar-r/finch/commit/321487c9309a73625512255ff86b6ffc6977b86e))
...
* **deps:** bump k8s.io/apimachinery from 0.26.2 to 0.26.3 ([#306](https://github.com/cezar-r/finch/issues/306)) ([fe392cb](https://github.com/cezar-r/finch/commit/fe392cb07cb4ca50b064bbb6f6667b7942047ffb))
* **deps:** Bump k8s.io/apimachinery from 0.26.3 to 0.27.1 ([#366](https://github.com/cezar-r/finch/issues/366)) ([b93d3a8](https://github.com/cezar-r/finch/commit/b93d3a8ed8eef42321200ac1386b61765e0b8348))
* **deps:** Bump k8s.io/apimachinery from 0.27.1 to 0.27.2 ([#407](https://github.com/cezar-r/finch/issues/407)) ([e6cbd2c](https://github.com/cezar-r/finch/commit/e6cbd2c5dba8af5cab9ea8a37a33c580ee4edef9))
* **deps:** Bump k8s.io/apimachinery from 0.27.2 to 0.27.3 ([#454](https://github.com/cezar-r/finch/issues/454)) ([d6746a4](https://github.com/cezar-r/finch/commit/d6746a447e10bed6c13d197c8d693b27e02ac3aa))
* **deps:** Bump k8s.io/apimachinery from 0.27.3 to 0.27.4 ([#487](https://github.com/cezar-r/finch/issues/487)) ([444bbc0](https://github.com/cezar-r/finch/commit/444bbc0779dbe22207fec471389810e398c1cf50))
* **deps:** Bump k8s.io/apimachinery from 0.27.4 to 0.28.0 ([#535](https://github.com/cezar-r/finch/issues/535)) ([8df84cf](https://github.com/cezar-r/finch/commit/8df84cf8c54bd772c28a83df918c251a540c881a))
* **deps:** Bump k8s.io/apimachinery from 0.28.0 to 0.28.1 ([#543](https://github.com/cezar-r/finch/issues/543)) ([675f76f](https://github.com/cezar-r/finch/commit/675f76fa6d8874587c09237faeb82d9f96c14adb))
* **deps:** Bump k8s.io/apimachinery from 0.28.1 to 0.28.2 ([#568](https://github.com/cezar-r/finch/issues/568)) ([915d658](https://github.com/cezar-r/finch/commit/915d658fbd6581eec437f2c31121366ff77a5981))
* **deps:** Bump k8s.io/apimachinery from 0.28.2 to 0.28.3 ([#652](https://github.com/cezar-r/finch/issues/652)) ([05f9d53](https://github.com/cezar-r/finch/commit/05f9d53dab468546918a332f0fc18449de774487))
* **deps:** Bump k8s.io/apimachinery from 0.28.3 to 0.28.4 ([#697](https://github.com/cezar-r/finch/issues/697)) ([e064d94](https://github.com/cezar-r/finch/commit/e064d94b71acbd7d160c3f061ff3ade7caae3333))
...
* **deps:** Bump lima version ([#302](https://github.com/cezar-r/finch/issues/302)) ([0269743](https://github.com/cezar-r/finch/commit/026974314254df1e4047ea5130ba50464608bb1d))
* **deps:** Bump lima version ([#354](https://github.com/cezar-r/finch/issues/354)) ([c721ee6](https://github.com/cezar-r/finch/commit/c721ee69f470eaf81b24fc043f088713fce88ad6))
* **deps:** Bump lima version ([#362](https://github.com/cezar-r/finch/issues/362)) ([5e03a4d](https://github.com/cezar-r/finch/commit/5e03a4d40c63a8fcc5a79bdda2ebfec6f993db3c))
* **deps:** Bump lima version ([#368](https://github.com/cezar-r/finch/issues/368)) ([8e4dfe4](https://github.com/cezar-r/finch/commit/8e4dfe4092a959d853549ed980e1c36a9e630be8))
* **deps:** Bump lima version ([#476](https://github.com/cezar-r/finch/issues/476)) ([7b330d3](https://github.com/cezar-r/finch/commit/7b330d3e2bd4cc623f46762c8e3b120ddc18f3b0))
* **deps:** Bump submodules ([#304](https://github.com/cezar-r/finch/issues/304)) ([b38af9f](https://github.com/cezar-r/finch/commit/b38af9fe0e5c4ffb3eb94641d70dd16e3fe7c833))
* **deps:** Bump submodules ([#307](https://github.com/cezar-r/finch/issues/307)) ([1a914ec](https://github.com/cezar-r/finch/commit/1a914ec11c9fcbbb56982c3361a3716ab7a946b2))
* **deps:** Bump submodules ([#319](https://github.com/cezar-r/finch/issues/319)) ([e671224](https://github.com/cezar-r/finch/commit/e671224bdb87983bce0db6e797ccfe71fb5dfc63))
* **deps:** Bump submodules ([#332](https://github.com/cezar-r/finch/issues/332)) ([5923ae2](https://github.com/cezar-r/finch/commit/5923ae2933e6cb2e9bf9e74db4584679af56c471))
* **deps:** Bump submodules ([#340](https://github.com/cezar-r/finch/issues/340)) ([daed9e2](https://github.com/cezar-r/finch/commit/daed9e24228b82b6d45c2eb43e86101b2a4420c9))
* **deps:** Bump submodules ([#371](https://github.com/cezar-r/finch/issues/371)) ([19fc0c5](https://github.com/cezar-r/finch/commit/19fc0c5d16a6d2fb876b05575420a8080c8a3562))
* **deps:** Bump submodules ([#375](https://github.com/cezar-r/finch/issues/375)) ([70fe4c3](https://github.com/cezar-r/finch/commit/70fe4c3e0320f237d2e4501fbe2bc4d3320ef3e9))
* **deps:** Bump submodules ([#402](https://github.com/cezar-r/finch/issues/402)) ([06d86b2](https://github.com/cezar-r/finch/commit/06d86b2bc348db9f0d8d02678faee556719b883d))
* **deps:** Bump submodules ([#439](https://github.com/cezar-r/finch/issues/439)) ([e9551b5](https://github.com/cezar-r/finch/commit/e9551b50010deb43ad26dcd3671ec2f246e84ed6))
* **deps:** Bump submodules ([#482](https://github.com/cezar-r/finch/issues/482)) ([92f2494](https://github.com/cezar-r/finch/commit/92f2494f17bde67b785ccf444ac6525b7a856a6c))
...
* **deps:** Bump submodules and dependencies ([#521](https://github.com/cezar-r/finch/issues/521)) ([1b3ad94](https://github.com/cezar-r/finch/commit/1b3ad94f9477eb3f8d33cbea90880f78ca403ff7))
* **deps:** Bump submodules and dependencies ([#544](https://github.com/cezar-r/finch/issues/544)) ([94b7497](https://github.com/cezar-r/finch/commit/94b74978e135fbf6375fe1a21ce4b64b77db5ee7))
* **deps:** Bump submodules and dependencies ([#551](https://github.com/cezar-r/finch/issues/551)) ([baf645f](https://github.com/cezar-r/finch/commit/baf645f250344a42bc4ee3ea53e97b2c82dbb55a))
* **deps:** Bump submodules and dependencies ([#565](https://github.com/cezar-r/finch/issues/565)) ([c02413f](https://github.com/cezar-r/finch/commit/c02413f47ade25232830a04548625297267caf9f))
* **deps:** Bump submodules and dependencies ([#567](https://github.com/cezar-r/finch/issues/567)) ([f70314e](https://github.com/cezar-r/finch/commit/f70314ef4a517d1fb69dc8444e621262f7e4dcd0))
* **deps:** Bump submodules and dependencies ([#637](https://github.com/cezar-r/finch/issues/637)) ([b094751](https://github.com/cezar-r/finch/commit/b094751d3ba56c7855fc6f3af7b8bef2618a7206))
* **deps:** Bump submodules and dependencies ([#722](https://github.com/cezar-r/finch/issues/722)) ([667c692](https://github.com/cezar-r/finch/commit/667c6923478696da86f3b899edf9a0efdc7c7b9c))
* **deps:** Bump submodules and dependencies ([#724](https://github.com/cezar-r/finch/issues/724)) ([bb1a273](https://github.com/cezar-r/finch/commit/bb1a273e0b966599d77dd649002e2896ed8b98e5))
...
* **deps:** Bump submodules and dependencies ([#895](https://github.com/cezar-r/finch/issues/895)) ([c7388bb](https://github.com/cezar-r/finch/commit/c7388bb9638d0c2306efc9dc6c4f11996d6f11bb))
...
* **feat:** enable Virtualization.framework and Rosetta ([#282](https://github.com/cezar-r/finch/issues/282)) ([fd3bf19](https://github.com/cezar-r/finch/commit/fd3bf19ae454b493fd7f9b1b85a5522881020af1))
* make finch work on windows with wsl2 ([#649](https://github.com/cezar-r/finch/issues/649)) ([31cdc41](https://github.com/cezar-r/finch/commit/31cdc411d29758bae54a0b3fdb37be2777bd9fdc))
...
* add experimental support for Cosign signing and verification ([#296](https://github.com/cezar-r/finch/issues/296)) ([84c2634](https://github.com/cezar-r/finch/commit/84c2634b7c1226ba9746d0cda4d22ec571454160))
...
* adding config option for SOCI installation on VM ([#506](https://github.com/cezar-r/finch/issues/506)) ([a2e077b](https://github.com/cezar-r/finch/commit/a2e077b8f72dc8d8d833aedce31b3ad3f9f45eb4))
* adds support bundles ([#210](https://github.com/cezar-r/finch/issues/210)) ([cc6be65](https://github.com/cezar-r/finch/commit/cc6be6577c97697e99112a7b693eff2664b747ef))
* ECR credential integration into Finch  ([#462](https://github.com/cezar-r/finch/issues/462)) ([d3514b3](https://github.com/cezar-r/finch/commit/d3514b3dbe69e1bed3d40838af01ebec184f7413))
* make Virtualization Framework default ([#956](https://github.com/cezar-r/finch/issues/956)) ([75b69b8](https://github.com/cezar-r/finch/commit/75b69b8a79d51c71d21fbddec15e5593c717edcf))
* support push with SOCI ([#578](https://github.com/cezar-r/finch/issues/578)) ([69721b7](https://github.com/cezar-r/finch/commit/69721b76151a4c24d82cdc1c9338bacf72afb15d))
* supports adding files inside the VM to support bundles ([#549](https://github.com/cezar-r/finch/issues/549)) ([3b1df46](https://github.com/cezar-r/finch/commit/3b1df4697e7b020d6c7339fb71bacf62ca0b3ee0))
...
* Add cleanup script to Makefile ([#444](https://github.com/cezar-r/finch/issues/444)) ([da91f87](https://github.com/cezar-r/finch/commit/da91f87369e5fde221b8edbac374954e71dae947))
...
* always force stop when using Virtualization.framework ([#350](https://github.com/cezar-r/finch/issues/350)) ([c521f1f](https://github.com/cezar-r/finch/commit/c521f1f65d406094c653b7a78d0009285b9fc627))
* Change the default behavoir for deleting .finch folder to false when uninstall ([#732](https://github.com/cezar-r/finch/issues/732)) ([e818743](https://github.com/cezar-r/finch/commit/e8187432a02c59a821a0d3b39c9cbc51f75a60cd))
* Clean up all previous finch version installation registries in postinstall and uninstall ([#688](https://github.com/cezar-r/finch/issues/688)) ([9afc0b9](https://github.com/cezar-r/finch/commit/9afc0b9a5e73a3c261aeac87b977e44129b311bd))
* configure aws creds in sync submodules/deps action ([#518](https://github.com/cezar-r/finch/issues/518)) ([b67452e](https://github.com/cezar-r/finch/commit/b67452e012d5d00f2ff66e023b4672f7957fe625))
...
* Correctly set and pick up environment variables ([#315](https://github.com/cezar-r/finch/issues/315)) ([05227ce](https://github.com/cezar-r/finch/commit/05227ce03055223bc7ffd10c634cc75a9632634e))
* ecr credential helper hash check ([#668](https://github.com/cezar-r/finch/issues/668)) ([4b1b0a2](https://github.com/cezar-r/finch/commit/4b1b0a2fa515bcfaaa6784ffa53a5918245cbd72))
* ecr creds helper and credential_process ([#510](https://github.com/cezar-r/finch/issues/510)) ([0525753](https://github.com/cezar-r/finch/commit/0525753105403e27e5d1372588c0c87aa6b6cbe6))
...
* enables bridge-nf-call-iptables by default ([#539](https://github.com/cezar-r/finch/issues/539)) ([6ea1499](https://github.com/cezar-r/finch/commit/6ea1499c1320545ba4efe8a7820dcf0998e28782))
...
* explicitly set permissions for socket_vmnet dependencies ([#363](https://github.com/cezar-r/finch/issues/363)) ([0801b88](https://github.com/cezar-r/finch/commit/0801b8841776e7a08d2a0826bbca535310b02f37))
* Fix to be able to run finch build with --ssh option ([#696](https://github.com/cezar-r/finch/issues/696)) ([4d1e6cf](https://github.com/cezar-r/finch/commit/4d1e6cf6d8f4b6f2cbdf0229e8dcf4ad0c80d80c))
* Fix to delete ~/.finch when uninstalling finch ([#703](https://github.com/cezar-r/finch/issues/703)) ([8d7389f](https://github.com/cezar-r/finch/commit/8d7389f607fc0211ebd6cfafe13197b945d877a3))
* give pull request write permissions to sync job ([#520](https://github.com/cezar-r/finch/issues/520)) ([55b5235](https://github.com/cezar-r/finch/commit/55b5235d50feb6557108c00cd8543d21f1fdf315))
* give token write perms to sync-submodules ([#519](https://github.com/cezar-r/finch/issues/519)) ([8b639ea](https://github.com/cezar-r/finch/commit/8b639eac14691caa99a6bfddd61be0b811a796d9))
...
* improve creds helper UX ([#673](https://github.com/cezar-r/finch/issues/673)) ([bc238cf](https://github.com/cezar-r/finch/commit/bc238cf9383d0fbc983a7f76f2cc15821eafd265))
* **Makefile:** use POSIX tar syntax for stdin ([#529](https://github.com/cezar-r/finch/issues/529)) ([e222131](https://github.com/cezar-r/finch/commit/e2221310e1725b3a6072abe12e72f01859ce3320))
* Mount /var/folders to finch vm ([#525](https://github.com/cezar-r/finch/issues/525)) ([c97d2e9](https://github.com/cezar-r/finch/commit/c97d2e93edaf139c3960620ec00454f856a8daee))
...
* option to use installed lima for SOCI e2e tests ([#533](https://github.com/cezar-r/finch/issues/533)) ([8b66659](https://github.com/cezar-r/finch/commit/8b666590631235f6430d652d5c50f0047a120893))
...
* quote recursive calls to make ([#515](https://github.com/cezar-r/finch/issues/515)) ([d603096](https://github.com/cezar-r/finch/commit/d6030965414e80e1f3c550e67097ce5f34aeff41))
...
* remove virtual machine image when running make clean ([98c8ee4](https://github.com/cezar-r/finch/commit/98c8ee4f783d01cb1340e77b508d868c3bb4bf04))
...
* resolve shellcheck warnings ([#684](https://github.com/cezar-r/finch/issues/684)) ([d9f695a](https://github.com/cezar-r/finch/commit/d9f695a39f17af6ab00722fbf5191b6fa5c9166b))
* Restart buildkit after containerd when provisioning ([#461](https://github.com/cezar-r/finch/issues/461)) ([fca1828](https://github.com/cezar-r/finch/commit/fca182877ca616257527f6186dd1e88b2919feeb))
* run SOCI as a systemd service ([#667](https://github.com/cezar-r/finch/issues/667)) ([24fd649](https://github.com/cezar-r/finch/commit/24fd649152b3ca18a1024d3a2ea40806c0c96cf2))
* soci being reset on vm stop/start ([#672](https://github.com/cezar-r/finch/issues/672)) ([9df7d32](https://github.com/cezar-r/finch/commit/9df7d325b25fe98fdb8327bc4603ae4441b6a190))
* sort volume args in DOCKER_COMPAT mode ([#417](https://github.com/cezar-r/finch/issues/417)) ([6a8ca1a](https://github.com/cezar-r/finch/commit/6a8ca1a559dada6ed320c9454fbc3229446a0a40))
...
* Stop lima process in postinstall and uninstall ([#438](https://github.com/cezar-r/finch/issues/438)) ([975c4ee](https://github.com/cezar-r/finch/commit/975c4ee42c1529673a51382c62c4096dc663f80a))
...
* Use LimaUser method instead of host user name ([#712](https://github.com/cezar-r/finch/issues/712)) ([7c02e08](https://github.com/cezar-r/finch/commit/7c02e08394f667e1f69cd304ef0258c1f0ff1c0f))
...
* "always force stop when using Virtualization.framework" ([#370](https://github.com/cezar-r/finch/issues/370)) ([cb3051e](https://github.com/cezar-r/finch/commit/cb3051e60d80aabce550377696d4251c9a9b0eec))
* "chore(main): release 1.0.1" ([#727](https://github.com/cezar-r/finch/issues/727)) ([52e08d2](https://github.com/cezar-r/finch/commit/52e08d27d8a29b4988cb228d3d270d85ba54337a))
* "fix: resolve shellcheck warnings" ([#725](https://github.com/cezar-r/finch/issues/725)) ([8ea255a](https://github.com/cezar-r/finch/commit/8ea255abb64c653a8c35e82c9c17aec9904278c5))


### Miscellaneous Chores

* update Release-As version to 1.0.0 (not-squashed) ([2c97323](https://github.com/cezar-r/finch/commit/2c97323deccfbc860e304b3297c8e51f91b7e2c0))
* update Release-As version to 1.0.1 ([#731](https://github.com/cezar-r/finch/issues/731)) ([8fd5a70](https://github.com/cezar-r/finch/commit/8fd5a705e01823d159d1c48b06a8d7bc84f61ee3))
